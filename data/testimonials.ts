...
export const testimonials: Testimonial[] = [
  {
    ...
    content:
      "Joining Fitlife was the best decision I've made for my health. The trainers are exceptional, and the community is so supportive. I've lost 20 pounds and gained confidence!",
    rating: 5,
  },
  {
    id: "2",
  ...
  },
  {
    ...
    content:
      "I love the variety of classes offered at Fitlife. From yoga to HIIT, there's something for everyone. The instructors are knowledgeable and always motivating.",
    rating: 5,
  },
];
